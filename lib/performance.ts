 ...
 * belong in the return. Keeping them out of `netFlow` lets them flow through
 * `(B.equity - netFlow) / A.equity` as return.
 *
...
export function computeTWR(snapshots: PortfolioSnapshot[], cashFlows: CashFlowEvent[]): TwrResult | null {
  ...
  for (let i = 1; i < sorted.length; i++) {
    ...
    const ret       = (B.equity - netFlow) / A.equity - 1;
